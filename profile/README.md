...
| 1 | [push_swap](https://github.com/42lx/push_swap) | C | Sort a stack of integers under some unconventional constraints. Achieves at max 3xxx ops for n=500 (worst case across 1,000,000 runs). Includes `--bench` flag. Subject v1.1 | WIP |
