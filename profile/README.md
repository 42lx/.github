...
|----|---------|------|-------------|-------|
| 0 | [libft](https://github.com/42lx/libft)| C | Some libc functions rebuilt from scratch, plus extras. C89-compliant, 32/64-bit portable, and using only pointer arithmetic instead of indexing. Subject v19.2 | WIP |
